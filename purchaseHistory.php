...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
            $transactionrs = Database::search("SELECT *FROM `invoice` WHERE `buyer_email`='" . $_SESSION["user"]["email"] . "'  AND `status`='1';");
            ...
            ?>
                ...
                <div class="col-12">
                    <div class="row mx-2 my-2 shadow py-4">
                        <div class="col-1 bg-dark bg-opacity-75 border d-none d-lg-block">
                        ...
                        <div class="col-10  bg-white border col-lg-3">
                            <div class="card my-2">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div class="card-body">
                                            <h6 class="card-title font-quicksand">Tracking No. - : <?php echo $transaction["order_id"];?></h6>
                                            <p class="card-text font-quicksand"><?php echo $product["description"];?>.</p>
                                            <p class="card-text font-quicksand">Price -: Rs. <?php echo $product["price"];?>.00</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php 
                    $buyerrs=Database::search("SELECT * FROM `users` WHERE `email`='".$transaction["users_email"]."';");
                    ...
                    ?>
                        ...
                        <div class="col-2 col-lg-1 mt-4">
                            <label class="btn btn-danger bg-opacity-50 font-quicksand fs-1" onclick="moveToTrash();"><i class="bi bi-trash-fill"></i></label>
                        </div>

                    </div>

                    <!-- Modal -->
                    <div class="modal" tabindex="-1" id="trashModel">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-floating mb-3">
                                        <p class="font-quicksand fs-6 fw-bold">Apple iPhone 12 Pro Max</p>
                                        <p class="font-quicksand fs-6">Price : 231000.00</p>
                                        </p>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger">Move <i class="bi bi-trash-fill"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
